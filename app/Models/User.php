...
class User extends Authenticatable
{
    ...
    public function workingInvest(){
        $amt= Investment::where('user_id',Auth::user()->id)->where('walletType',2)->sum('working_amt');
        return $amt;
    }

    public function cashInvest(){
        $amt= Investment::where('user_id',Auth::user()->id)->where('walletType',2)->sum('cash_amt');
        return $amt;
    }
    ...
    {
        return $this->hasMany('App\Models\Income','user_id','id')->where('remarks','Reward Bonus');
    } 
    ...
    {
        return $this->hasMany('App\Models\Income','user_id','id')->whereIn('remarks',['Farming Profit','Reward Profit'])->where('credit_type',0);
    } 
