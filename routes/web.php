...
Route::get('/ai-trading', [App\Http\Controllers\FrontController::class, 'faq'])->name('ai-trading');
...
Route::get('/transfer-report', [App\Http\Controllers\UserPanel\AddFund::class, 'transfer_report'])->name('user.transfer-report');
...
Route::any('/confirm', [App\Http\Controllers\UserPanel\AddFund::class, 'SubmitBuyFund'])->name('user.confirm');
Route::any('/transfer_fund', [App\Http\Controllers\UserPanel\AddFund::class, 'submitfundtransfer'])->name('user.transfer_fund');

Route::get('/cancel-fund/{id}', [App\Http\Controllers\UserPanel\AddFund::class, 'cancel_payment'])->name('user.cancel-fund');
// end add fund

// invest
Route::get('/invest', [App\Http\Controllers\UserPanel\Invest::class, 'index'])->name('user.invest');
Route::get('/investment', [App\Http\Controllers\UserPanel\Invest::class, 'investment'])->name('user.investment');
