...
<head>
    ...
    <meta property="og:image"
        content="/{{ asset('') }}main/assets/eQPywYAlnPNuvenAX6Nb/images/preview.jpg?version=20">
                    ...
                    <div class="mobile-auth-panel-block">
                        <div class="mobile-auth-panel">
                            ...
                            <div class="mobile-auth-registration-btn-block">
                                <a href="{{route('register')}}" class="mobile-auth-registration-btn purple-btn">Sign Up</a>
                            </div>
                        </div>
                    </div>
