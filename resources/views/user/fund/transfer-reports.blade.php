        ...
        <div class="row">
            <div class="col-12">
                <div class="section-title-block">
                    <h2 class="section-title">Transfer Reports</h2>
                </div>
                <div class="section-descr">
                    Transfer Reports on your account. Track and monitor the movement of your crypto assets.
                </div>
                                            ...
                                            <div class="transaction-item-right">
                                                ...
                                                <div class="transaction-item-more-info-link-block">
                                                    <div
                                                        ...
                                                        @if ($value->user_id_to === Auth::user()->username)
