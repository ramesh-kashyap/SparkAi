        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="section-descr">
					Control your deposits. Keep track of your profit and the current status of your investment
                </div>
                                                            ...
                                                            <div class="field field--iconed field--select">
                                                                <select name="type" onchange="location = this.value;"
                                                                    ...
                                                                    <option
                                                                        ...
                                                                        value="{{route('user.DepositHistory')}}" selected>Deposits</option>
                                                        ...
                                                        <div class="transaction-item-more-info-tooltip dropdown-menu"
                                                            ...
                                                            <div
                                                                ...
                                                                <div
                                                                    ...
                                                                    Wallet: <strong>{{($value->walletType==1)?"Crypto":"Cash"}}
                                                                        </strong>
